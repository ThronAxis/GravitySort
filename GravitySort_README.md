...
├── viz/
│   ├── gl_interop.cu          ← OpenGL + CUDA zero-copy thread heatmap
...
Full roofline PNG: `profiling/roofline.png` (generated by `profiling/roofline.py`).
